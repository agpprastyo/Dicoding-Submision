...
mixin _$Recipe {
  ...
  dynamic get preparationMinutes => throw _privateConstructorUsedError;
  dynamic get cookingMinutes => throw _privateConstructorUsedError;
  ...
  List<dynamic>? get diets => throw _privateConstructorUsedError;
...
class _$RecipeImpl implements _Recipe {
  ...
  final List<dynamic>? _diets;
  @override
  List<dynamic>? get diets {
    final value = _diets;
    if (value == null) return null;
...
abstract class _Recipe implements Recipe {
  const factory _Recipe(
      ...
      final dynamic originalId,
      final double? spoonacularScore,
      final String? spoonacularSourceUrl}) = _$RecipeImpl;
  ...
  String? get gaps;
  @override
  dynamic get preparationMinutes;
  @override
  dynamic get cookingMinutes;
  @override
...
abstract class _Step implements Step {
  const factory _Step(
      ...
      final List<Ent>? ingredients,
      final List<Ent>? equipment,
      final Length? length}) = _$StepImpl;
...
mixin _$Ent {
  ...
  String? get image => throw _privateConstructorUsedError;
  Length? get temperature => throw _privateConstructorUsedError;
...
abstract class $EntCopyWith<$Res> {
  ...
  $LengthCopyWith<$Res>? get temperature;
}
...
class _$EntCopyWithImpl<$Res, $Val extends Ent> implements $EntCopyWith<$Res> {
  ...
  $LengthCopyWith<$Res>? get temperature {
    ...
    return $LengthCopyWith<$Res>(_value.temperature!, (value) {
...
class _$EntImpl implements _Ent {
  ...
  @override
  String toString() {
    return 'Ent(id: $id, name: $name, localizedName: $localizedName, image: $image, temperature: $temperature)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, localizedName, image, temperature);
...
abstract class _Ent implements Ent {
  const factory _Ent(
      ...
      final String? localizedName,
      final String? image,
      final Length? temperature}) = _$EntImpl;
...
abstract class _Measures implements Measures {
  const factory _Measures({final Metric? us, final Metric? metric}) =
      _$MeasuresImpl;
